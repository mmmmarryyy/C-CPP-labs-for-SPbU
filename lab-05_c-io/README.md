...
Можно использовать либо свою (из лабораторной №4), либо, после наступления дедлайна в вашей группе по предыдущей лабораторной, запросить у преподавателя решение.
...
* `<action...>` — операция, которую нужно выполнить над точками. Один или более параметров, которые
  могут принимать значения в соотвествие с ровно одинм из следующих вариантов:
